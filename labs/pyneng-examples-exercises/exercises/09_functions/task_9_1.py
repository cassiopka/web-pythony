...
def generate_access_config(intf_vlan_mapping, access_template):
    ...
    for intf, vlan in intf_vlan_mapping.items():
        ...
        for com in access_template:
            if "vlan" in com:
                result.append(com + " " + str(vlan))
            else:
                result.append(com)
    return result


resulting_config = generate_access_config(access_config, access_mode_template)

for i in resulting_config:
    print(i)